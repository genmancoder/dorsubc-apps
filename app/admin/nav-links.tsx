    ...
    return (
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <Link href="/admin/windows"  className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                    ...
                    <Link href="/admin/status"  className="bg-white p-6 rounded-lg shadow-sm border hover:shadow-md transition-shadow">
                        <div className="flex items-center space-x-4">
