...
export default function Admin() {
    ...
    return (
        <div className="max-w-2xl mx-auto mt-10 text-center bg-white p-5 scroll-auto rounded-md mb-8">
            ...
            <button onClick={callNext} className="bg-blue-400 text-white px-6 py-3 rounded mr-2">
                Previous
            </button>
            <button onClick={callNext} className="bg-green-600 text-white px-6 py-3 rounded mr-2 cursor-pointer">
                Next
            </button>
            <button onClick={callTicket} className="bg-red-600 text-white px-6 py-3 rounded mr-2">
                Call Current
            </button>
            <button onClick={showDialog} className="bg-red-800 text-white px-6 py-3 rounded mr-2">
                Clear Queue
            </button>
