...
import { Volume2, ChevronsRight, ChevronsLeft } from "lucide-react";
...
export default function Queue() {
  ...
  const [, setPausedQueue] = useState<PausedQueue[]>([]);
  ...
  const [, setUserWindows] = useState<WindowDetails[]>([]);
  const [, setIsWindowsModalOpen] = useState(false);
